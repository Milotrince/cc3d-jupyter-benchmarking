...
from cc3d.core.PyCoreSpecs import Metadata, PottsCore, CellTypePlugin, VolumePlugin, BlobInitializer, ContactPlugin
...
def main():
    ...
    specs = [Metadata(num_processors=8), PottsCore(dim_x=100, dim_y=100, neighbor_order=2)]
    ...
    # Execute 10k steps
    while cc3d_sim.current_step < 1000:
        cc3d_sim.step()
